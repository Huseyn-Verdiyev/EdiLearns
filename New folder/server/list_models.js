...
const genAI = new GoogleGenerativeAI(process.env.GEMINI_API_KEY || "AIzaSyCO4vj-AHxcyeowJLM8fm5piUchgQyt4PU");
...
async function listModels() {
    try {
        ...
        const key = process.env.GEMINI_API_KEY || "AIzaSyCO4vj-AHxcyeowJLM8fm5piUchgQyt4PU";
