...
app.use(cors({
    origin: [
        ...
        'http://localhost:5500',
        'http://127.0.0.1:5500',
        'https://edutaskacademy.netlify.app',
        'https://edutaskacademy3.netlify.app'
    ],
    credentials: true
}));
...
async function startServer() {
    try {
        ...
        // Root endpoint
        app.get('/', (req, res) => {
            res.json({ message: 'EduTask API Server', version: '1.0', docs: '/api/health' });
        });
