...
-- Insert sample news
INSERT INTO news (title, category, content, image_url, author_id)
VALUES ('Məktəbdə "Elm Həftəsi" başlayır', 'elm', 'Bu həftə laboratoriya təcrübələri və açıq dərslər planlaşdırılıb. Şagirdlərimiz fəal iştirak edə bilərlər.', NULL, 7);

INSERT INTO news (title, category, content, image_url, author_id)
VALUES ('Olimpiada seçim mərhələsi başa çatdı', 'olimpiada', 'Riyaziyyat və informatika üzrə ilkin seçim başa çatdı. Nəticələr gələn həftə elan olunacaq.', NULL, 8);
...
INSERT INTO quiz_questions (quiz_id, question, type, options, correct_answer)
VALUES (1, 'Şah İsmayılın atasının adı nə idi?', 'multiple', '["Şeyx Heydar", "Şeyx Səfi", "Şah Təhmasib", "Şah Abbas"]', 0);
